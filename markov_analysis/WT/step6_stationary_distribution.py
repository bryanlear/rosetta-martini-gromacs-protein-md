...
matrices *per block* (blocks 1 and 3), restricts each to its own
...
BLOCKS    = ["msm_block1", "msm_block3"]       # block 2 excluded
...
def plot_all(out_dir, results):
    ...
    ax.set_ylabel("π_i")
    ax.set_title("Aggregated stationary distribution  (blocks 1 + 3)")
