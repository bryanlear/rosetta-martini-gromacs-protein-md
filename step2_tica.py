...
def plot_implied_timescales(scan, dt_ps, outdir):
    ...
    ax.set_title("TICA Implied Timescales — WT Nav1.5", fontsize=14)
    ax.set_yscale("log")
    ax.set_xscale("log")
...
def plot_eigenvalue_spectrum(eigenvalues, outdir):
    ...
    ax.set_title("TICA Eigenvalue Spectrum — WT Nav1.5", fontsize=14)
...
def plot_tic_projections(projections, block_names, dt_ps, outdir):
    ...
    fig.suptitle("TICA Projection — WT Nav1.5", fontsize=14)
    plt.tight_layout()
    ...
    fig.suptitle("TIC-1 Time Series — WT Nav1.5", fontsize=14)
    plt.tight_layout()
    ...
    fig.suptitle("TICA 2D Histograms (all blocks) — WT Nav1.5", fontsize=14)
    plt.tight_layout()
...
def plot_cumulative_kinetic_variance(eigenvalues, outdir):
    ...
    ax.set_title("Cumulative Kinetic Variance — WT Nav1.5", fontsize=14)
    ax.legend()
    ax.grid(True, alpha=0.3)
    plt.tight_layout()
...
def main():
    ...
    print("=" * 65)
    print("  Step 2 — TICA  (PCA-whitened)  |  WT Nav1.5  (Martini 3 CG)")
    print("=" * 65)
